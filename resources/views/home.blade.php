                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="{{route('pesan.home')}}">All Products</a></li>
                            <li>
    ...
    <header class="bg-warning py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-black">
                ...
                <p class="lead fw-normal text-black-50 mb-0">SILAHKAN PILIH MEJU JAJANAN YANG DISUKA</p>
            </div>
        </div>
    </header>
    <!-- Section-->
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="{{route('pesan.detail',$p->id)}}">View Detail</a></div>
                        </div>
                    </div>
                </div>
                @endforeach
